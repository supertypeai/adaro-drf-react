    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, default='loc-title', max_length=50, null=True)),
                ('longitude', models.FloatField()),
                ('latitude', models.FloatField()),
                ('category', models.CharField(choices=[('daily', 'Daily'), ('six', 'Six'), ('hourly', 'Hourly')], default='daily', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='LocationData',
