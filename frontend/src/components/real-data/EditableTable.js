...
const EditableTable = ({ loc, data, setData, locCategory }) => {
    ...
    const save = async (id) => {
        ...
        try {
            ...
            const updatedEntry = { ...item, measurement: parseFloat(row.measurement) };
            newData.splice(index, 1, { ...item, measurement: parseFloat(row.measurement) });
            APIService.EditData(id, {
